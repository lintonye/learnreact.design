...
![transform function documentation](./input.png)

Scrolling down,

![inputValue must be a number](./value.png)
...
![useTransform function](./usetransform.png)
...
![less rotation card](./rotatemv.gif)
...
![opacity both sides](./opacity2.gif)
...
![opacity slowed down](./opacityslow.gif)
