...
![Sticky Scroll Effect](./stickyfinalresult.gif)
...
![three number scrolling](./threenumbers.gif)
...
![use-parallax dependency](./useparallax.png)
...
import { render } from "react-dom"
import { Frame, Scroll, useMotionValue, useTransform } from "framer"
import { usePositiveOffset, useSticky } from "use-parallax"
import "./styles.css"
```
