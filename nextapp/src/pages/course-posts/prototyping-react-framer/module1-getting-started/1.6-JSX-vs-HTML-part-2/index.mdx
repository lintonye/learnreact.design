import imgReplacingtextPng from './replacingtext.png'
import imgReplacingtextresultPng from './replacingtextresult.png'
import imgReplacingtextcurlyPng from './replacingtextcurly.png'
import imgCurlyresultPng from './curlyresult.png'
...
<img
  src={imgReplacingtextPng}
  alt={`Replacing text with 1+2 = 1+2`}
  width={730}
  height={118}
/>
...
<img
  src={imgReplacingtextresultPng}
  alt={`Replacing text result`}
  width={489}
  height={152}
/>
...
<img
  src={imgReplacingtextcurlyPng}
  alt={`Replacing text with curly brackets`}
  width={719}
  height={122}
/>
...
[What is React?](/posts/what-is-react/) and [Curly Braces in JSX](/posts/those-curly-braces-in-jsx)
