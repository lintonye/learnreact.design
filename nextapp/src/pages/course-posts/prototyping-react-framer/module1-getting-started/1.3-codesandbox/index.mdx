import imgCodesandboxreactPng from './codesandboxreact.png'
import imgIcon2Png from './icon2.png'
import imgIconPng from './icon.png'
import imgForkPng from './fork.png'
import imgGithubPng from './github.png'
import imgSigninPng from './signin.png'
...
<img
  src={imgCodesandboxreactPng}
  alt={`codesandbox image`}
  width={1920}
  height={902}
/>
...
<img src={imgIcon2Png} alt={`codesandbox close icon`} width={69} height={69} />

Or this icon eventually to fold the pane.

<img src={imgIconPng} alt={`codesandbox close icon`} width={70} height={71} />
...
<img src={imgForkPng} alt={`fork image`} width={115} height={59} />
...
<img src={imgGithubPng} alt={`github logo`} width={718} height={266} />
...
<img src={imgSigninPng} alt={`github sign in`} width={216} height={58} />
