...
import imgWhyPng from './why.png'
import imgOccurences2Png from './occurences2.png'
import imgSelectionPng from './selection.png'
import imgSingleselectPng from './singleselect.png'
import imgGoodselectionPng from './goodselection.png'
import imgFinalselectionPng from './finalselection.png'
...
<img src={imgWhyPng} alt={`weird frame positioning`} width={250} height={250} />
...
<img
  src={imgOccurences2Png}
  alt={`multiple occurrences`}
  width={244}
  height={233}
/>
...
<img src={imgSingleselectPng} alt={`single select`} width={246} height={173} />

### 2. Press CTR+D or CMD+D

<img src={imgGoodselectionPng} alt={`selection`} width={246} height={173} />

### 3. Press the right arrow → to align your carets and to deselect the Frames.

<img src={imgFinalselectionPng} alt={`selection`} width={246} height={173} />
