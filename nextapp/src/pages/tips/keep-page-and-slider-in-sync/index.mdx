...
export const meta = {
  ...
  sourceFile:
    'https://framer.com/projects/page-and-slider--zgWicO5nVsr6GVm6NpaB-aeoRI',
  tags: ['Code', 'Interactive Tools', 'Code Override', 'Framer'],
  video: 'page-and-slider.mp4',
  videoPoster: 'page-and-slider.mp4.jpg',
  slug: 'keep-page-and-slider-in-sync',
}
