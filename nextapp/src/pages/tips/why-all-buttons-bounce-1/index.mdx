import thumbnailImage from './all-buttons-bounce.mp4.jpg'
import thumbnailVideo from './all-buttons-bounce.mp4'
...
export const meta = {
  ...
  sourceFile:
    'https://www.dropbox.com/s/i9ocmujddnpvkf9/all-buttons-bounce.framerx?dl=0',
  tweet: null,
  thumbnailImage,
  thumbnailVideo,
}
