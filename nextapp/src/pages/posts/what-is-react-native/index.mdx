...
- _[What is React Native?](/2017/06/20/what-is-react-native) (this post)_
...
![The studio "Web Browser" is actually a lot busier than what you've seen.](./6-other-folks-at-web.png)
...
![The formation of React Native](./7-summon.png)
...
1. On your phone, download the Expo app. You can either download from here: [iOS](https://itunes.apple.com/app/apple-store/id982107779?pt=17102800&ct=www&mt=8), [Android](https://play.google.com/store/apps/details?id=host.exp.exponent), or search "Expo" in the App Store. The app's icon looks like <img src="./expo-ios.jpg" alt="Expo iOS icon" /> (or <img src="./expo-android.jpg" alt="Expo Android icon" /> on Android).
