...
![redux can work with many frameworks, maybe shake hands with React guy and others?](./work_well_with_other.png)
...
In tech slang, code that behaves like a math formula is called a "pure function". The fact that it doesn't change the input or anything else is referred to as having no "side effects".
...
![hot reloading](./hot-reloading.png)
