...
export const meta = {
  title: 'React useRef By Example: What It Is, Why We Need It',
...
<p>
  ...
  others. My goal is to distill the core concepts of React into digestable,
  visual pieces that are easy to understand and remember. I call them{' '}
  <span className="font-bold italic">React Mental Models</span>. They are about
  how to <em>think</em> in React.
</p>

  <p>
    What I'm striving is to show you not just the <em><strong>how</strong></em>, but the <em><strong>why</strong></em>. It's the solid basics you can use to build from -- so that you can confidently teach yourself moving forward.
  </p>
