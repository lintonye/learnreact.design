...
<div className="p-8 bg-yellow-100 border border-yellow-400 rounded-sm space-y-4 my-2">
  ...
  <Reactions
    ...
    revealAfterReaction={
      <>
        <p>
          Thanks for your feedback! Just like the "rerendering time loop"
          metaphor used here, I'm working on many others. My goal is to distill
          the core concepts of React into digestable, visual pieces that are
          easy to understand and remember. I call them{' '}
          <span className="font-bold italic">React Mental Models</span>. They
        ...
        <p>
          ...
          . It's the solid basics you can use to build from -- so that you can
