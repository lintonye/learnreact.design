...
<p>
  Just like the "rerendering time loop", I'm working on many others. My goal is
  to distill the core concepts of React into digestable, visual pieces that are
  easy to understand and remember. I call them{' '}
