...
export const meta = {
  ...
  description: `The React.useRef Hook is used for referencing DOM nodes as well as persisting a value across rerenders. This is an interactive guide to useRef with real-world examples.`,
  date: '2021-03-07',
  tags: ['react'],
  related: [
