import imgJackJpg from './jack.jpg'
import imgGeckoboard1Gif from './geckoboard1.gif'
import imgGeckoboard2Gif from './geckoboard2.gif'
import imgSurprise from './harness-surprise.png'
...
<img src={imgJackJpg} alt={`Jack`} width={900} height={400} />
...
<img src={imgGeckoboard1Gif} alt={`geckoboard1`} width={600} height={454} />
...
<img src={imgGeckoboard2Gif} alt={`geckoboard2`} width={600} height={262} />
...
<!-- <img src="./create-react-app.svg" style="width: 50%; min-width: 400px" /> -->
...
<!-- <img src="./tachyons.svg" style="width: 50%; min-width: 300px" /> -->
...
<!-- <img src="./storybook.svg" style="width: 50%; min-width: 300px;" /> -->
