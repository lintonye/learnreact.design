...
![waiting list](./waiting-list.png)

**Update 09/21/2018:** Now that Framer X is launched. Glad that I was able to guess a few things right. 😄 Check out this course I built: [Framer X + React](/framerx-react).
...
PS: Want to learn React to get prepared for Framer X? I've created a series of video courses tailored for designers. Check out [learnreact.design](https://learnreact.design/?utm_source=ux_planet&utm_campaign=framerx&utm_content=bottom)!
