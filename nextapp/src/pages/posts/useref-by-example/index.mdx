...
`useRef` is a built-in React Hook. It is, at least in my experience, one of the most confusing Hooks (perhaps right after `useEffect`). But if you spend some time to learn how it works, you'll see that it's actually a hidden gem 💎. It'll become a powerful tool in your arsenal.
...
4. A real-world example -- the like button below (click and hold for additional fun).
...
Let's check out the real thing! This is what we want to build (remember to click and hold):
