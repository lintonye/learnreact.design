...
I'll reveal this shiny gem <span className="mr-2">💎</span> for you in three steps: 1) how it works, 2) a couple of simple examples, and finally 3) a real-world example -- the like button below (click and hold for additional fun).
...
After a lot of struggle trying to understand `useRef`, I finally saw this single sentence. And it clicked! If you are hearing the clicking sound in your mind right now already, feel free to skip to [the examples section](TODO). Otherwise, if you are not familiar JavaScript classes or class instance variables, read on. This section is for you.
...
As straighforward this sounds, sometimes it's easy to forget it (I do it all the time). So remember, a React component is re-rendered all the time, so all the local variables will go into a time loop, over and over again.
