...
# subtitle: "React in comics"
---

import KungfuPanda from './KungfuPanda'
import Video from '../../design-system/Video'
// import ConvertKitForm from '../../design-system/ConvertKitForm'

![hole comic 1](./hole1.png)
...
![setWho choose the person](./setWho.png)
...
<Video src="./quiz-result.mp4" width="100%" />
...
![knowledge tree](./knowledge-tree.png) -->
