---
date: '2020-01-09'
title: "Busy Designers' Guide to Framer X: A 4-Week Plan"
# subtitle: "A 4-week plan"
---
...
<img src="./4-week-overview.gif" alt="4 week overview" width="100%" />

# Overview

There are perhaps a million things to learn in JavaScript, React and Framer X. But the truth is that you don't have to know all of it to do useful work. Instead, learn a little bit and try to apply it to your work as soon as possible.
...
## 2. See an overview of Framer X's advanced features

This [17-minute video](https://designcode.io/framer-playground-ui-interactions) by Meng To is a good overview of Framer X's advanced features. Watch it at 1.25x speed and you can get a good glance of what's possible.
...
![toggle](./week1-toggle.gif)

![checkbox](./week1-checkbox.gif)
...
Do you want to make the best of Framer X? You need to know both JavaScript and React. This can be daunting, I know.
...
![animate props](./animate-variants-transition.jpg)
...
![override-communicate](./overrides-talk.jpg)
...
![slider](./week3-slider.gif)
![ios task switcher](./week3-ios-task-switcher.gif)
...
![useAnimation](./week3-useAnimation.gif)
...
![card swipe](./week4-card-swipe.gif)
![bottom sheet](./week4-bottomsheet.gif)
...
![useMotionValue](./week4-useMotionValue.gif)
...
![useMotionValue and useAnimation](./week4-useMotionValue-useAnimation.gif)
...
So here you go! If you are a busy designer, and if you are familiar with HTML/CSS but new to JavaScript or React, this is the plan for you to learn the core of Framer X. In about 4 weeks!
