...
<div className="p-8 bg-yellow-100 border border-yellow-400 rounded-sm space-y-4">
  <p>
    As an extension to this article, I'm building an email course on React. My
    goal Of course, eventually you'd need to write code. But it doesn't mean you
    need to learn every aspect of it . Learn enough to be dangerous! If you
    think this is a good idea, Great move reading this post is a great first
    step to learn React. I'm also building an email course to .
  </p>
  <ConvertKitForm formId="124" subscribeButtonTitle="Keep Me Posted" />
</div>
