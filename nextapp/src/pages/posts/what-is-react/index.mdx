...
<CodeEditor
  ...
  onChange={(jsxJson, dispatch) =>
    dispatch({ type: 'update-footer', data: jsxJson })
  }
/>
...
Try to change the text on the button in the code of SearchBar below. What do you see?
...
<CodeEditor
  ...
  onChange={(jsxJson, dispatch) =>
    dispatch({ type: 'update-search-bar', data: jsxJson })
  }
/>
