...
Alright. Let's say we want to help Domo build an online hat store 🧢 (hint: it's interactive. Choose a hat for Domo!).

<DomoHatShopDemo />

<OffScreenDetector on="Header Main Footer" off="">
...
<OffScreenDetector on="Header" off="">
...
This works very similarly to components in design tools such as Framer and Figma.
