...
In fact, I bet even experienced React developers are not super clear about these concepts (for example, myself!). When I wrote the first version of this article a few years ago, I put focus on the wrong things. Hopefully this revision is more accurate!
