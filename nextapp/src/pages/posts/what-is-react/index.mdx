...
Try to change the text on the button in the code below. What do you see?
...
The SearchBar on both Header and Footer updates. Right? This works very similarly to components in design tools such as Framer and Figma.
