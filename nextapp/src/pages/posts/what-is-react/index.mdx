...
"React is a JavaScript library for building user interfaces." This is the official definition of React. But what if you are not familiar with JavaScript? What if you are not a developer? Would you still be able to make sense of (and learn) React? My answer is a firm YES.
...
Remember: You don't need to be an experienced developer to understand React!
...
To check out what the DOM looks like, right-click on this very page and choose "Inspect". Can you make sense of what's in the Elements tab?
...
<FullBleed className="grid grid-cols-2 items-start gap-x-8 my-8 pb-4 bg-indigo-50 z-20 justify-items-start">
...
## Write your first React component
  ...
  <div className="max-w-prose justify-self-end ml-8 space-y-5">
...
<div className="bg-indigo-100 px-3 py-3 rounded-md my-5 space-y-5">
...
<DomoHatShopDemo className="top-20 sticky z-10 mr-8" />
