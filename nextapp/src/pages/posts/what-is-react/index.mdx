...
<FullBleed className="grid grid-cols-2 items-start gap-x-4 my-8 bg-indigo-50 z-20 justify-items-start">
...
## Write your first React component
  ...
  <div className="max-w-prose justify-self-end">
...
<DomoHatShopDemo className="top-20 sticky z-10" />
