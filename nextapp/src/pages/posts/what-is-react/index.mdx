...
"React is a JavaScript library for building user interfaces." This is the official definition of React. But what if you are not familiar with JavaScript? Would you still be able to make sense of (and learn) React? My answer is a firm YES.
