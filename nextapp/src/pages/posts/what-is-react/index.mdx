...
That's the official definition of React. But what if you are not familiar with JavaScript? What if you are not a developer? Would you still be able to make sense of (and learn) React?
...
<FullBleed className="grid grid-cols-2 items-start space-x-8 my-8 bg-purple-50 z-20">

  <div className="col-start-1 col-end-3 text-3xl font-bold py-12 mb-8 justify-self-stretch text-center bg-gray-700 text-white ">
