...
This is a bird's view <span className='text-2xl'>🦅</span> but I'll also give you a telescope <span className='text-2xl'>🔭</span> . You'll not only see the big picture of what make React special, but also zoom in to get hands-on experience of writing an actual React component. And yes, no JS knowledge required!
