...
The important idea here is that we separate the data from the UI. We almost always work with the data instead of accessing the DOM nodes. We'll dive deeper and see more examples of this idea in the [next post](/1020/03/31/react-mental-models-working-with-input).
