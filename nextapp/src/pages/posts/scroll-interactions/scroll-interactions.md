...
![gif of sticky header](./sticky-scroll.gif)

What about this one?

![gif of iphone xr](./iPhoneXR.gif)

Or an SVG line tracing animation controlled by scrolling?

![gif of svg tracing](./svg-tracing.gif)
...
![canvas screenshot](./iphoneXR-canvas.png)
...
![iphone name size slowdown](./iphone-name-size-slowdown.gif)
...
![svg line tracing property panel](./svg-line-tracing-property-panel.gif)
...
![console output](./scroll-props-console.png)
...
![console output about](./about-props-console.png)
...
![snap and navigate](./snap-and-navigate.gif)
