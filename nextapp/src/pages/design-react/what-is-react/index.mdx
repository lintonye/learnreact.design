...
What exactly is React? Why is React so popular? What is DOM? What does like feel like to write a React app? Why do we need React?
...
This is React explained in plain English (and doodles 🌴). I'll give you a high-level (but hands-on) overview of the core ideas of React that make it special.

This article is an introduction to React for beginners. No JavaScript experience? No problem! As long as you have some basic HTML knowledge (e.g. how to write HTML tags), you should be able to enjoy this article and get some hands-on experience of writing a React component.
