...
It's important to pair the opening and closing tags. We'll get an error if missing a closing tag of a non-empty element, e.g.
...
The order of closing tags is also important. We'll get an error
